...
void compileUnsignedConstant(void) {
  //TODO
  if(lookAhead->tokenType == TK_NUMBER || lookAhead->tokenType == TK_IDENT || lookAhead->tokenType == TK_CHAR){
...
void compileBasicType(void) {
  //TODO
  if(lookAhead->tokenType == KW_INTEGER || lookAhead->tokenType == KW_VAR){
    eat(lookAhead->tokenType);
  }
...
void compileParam(void) {
  //TODO
  if(lookAhead->tokenType != KW_VAR && lookAhead->tokenType != TK_IDENT) error(ERR_INVALIDPARAM, lookAhead->lineNo, lookAhead->colNo);
